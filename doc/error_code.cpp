...
/* видимо ещё и свой any писать придётся :(
   ...
   Значит статические члены могут заполнить таблицу всеми типами, а потом читать без мьтексов.
   ...
   Итого: boost::any(переносим; думаю занимает на стеке как 4-й, но много на куче);
      boost::variant + перебор(2-й; по-скорости примерно как 5-й, но эксплуатирует стек лучше; но
        перед 5-м есть недостаток: если ошибка большая то он много ест места);
